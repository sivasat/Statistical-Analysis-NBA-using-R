...
```{r tab-stat_analysis, echo=FALSE,warning=FALSE,message=FALSE}
...
geo <- ggplot(acc, aes(x = seconds.left, y = accuracy)) + geom_point() + geom_smooth()
```
...
#geo1 <-graph2 + labs(title = "Accuracy Average") + xlab("Seconds left on shot clock") + ylab("Accuracy")
```
```{r, echo = FALSE,warning=FALSE }
grid.arrange(geo, graph2,
             nrow = 1)
```
